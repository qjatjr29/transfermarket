...
const usePlyerStat = () => {
    ...
    return { loading, bundesligaPlayers };
}

const BundesPlayerStat = () => {
    const { loading, bundesligaPlayers } = usePlyerStat();
    ...
    return (
        loading ? (
            <Loader>
                <Helmet>
                    <title>BundesLiga Player Stats</title>
                </Helmet>
            </Loader>
        ) : (
            <Container>
...
export default BundesPlayerStat;