...
const usePlyerStat = () => {
    ...
    return { loading, serieAPlayers };
}

const SerieAPlayerStat = () => {
    const { loading, serieAPlayers } = usePlyerStat();
    ...
    return (
        loading ? (
            <Loader>
                <Helmet>
                    <title>Serie A Player Stats</title>
                </Helmet>
            </Loader>
        ) : (
            <Container>
...
export default SerieAPlayerStat;