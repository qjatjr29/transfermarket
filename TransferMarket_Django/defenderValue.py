...
def getDefenderValue():
    
    url="https://www.transfermarkt.com/spieler-statistik/wertvollstespieler/marktwertetop/plus/ausrichtung/Abwehr/spielerposition_id/alle/altersklasse/alle/jahrgang/0/land_id/0/kontinent_id/0/yt0/Show/0//page/"
...
defender= getDefenderValue()

def addNewItem(playerValue):
    last_inserted_items=DefenderValue.objects.last()
