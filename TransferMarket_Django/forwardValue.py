...
def getForwardValue():
    ...
    url="https://www.transfermarkt.com/spieler-statistik/wertvollstespieler/marktwertetop/plus/ajax/yw1/ausrichtung/Sturm/spielerposition_id/alle/altersklasse/alle/jahrgang/0/land_id/0/kontinent_id/0/yt0/Show/0//page/"
...
forward= getForwardValue()

def addNewItem(playerValue):
    last_inserted_items=ForwardValue.objects.last()
